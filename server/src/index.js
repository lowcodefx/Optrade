...
app.use('/api/holdings',  resolveUser, require('./routes/holdings'))
app.use('/api/watchlist', resolveUser, require('./routes/watchlist'))
app.use('/api/tradelog',  resolveUser, require('./routes/tradelog'))
